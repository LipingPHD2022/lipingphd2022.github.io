...
<div class="research-collection">
  <article class="research-entry">
    ...
    <ul class="research-entry__presentations">
      ...
      <li>POMS-China International Conference 2025, Hainan, China (session chair)</li>
      <li>POMS Annual Conference 2023, Minneapolis, USA</li>
    </ul>
  </article>
  <article class="research-entry">
    <p class="research-entry__citation"><strong>Improved Collaborative Filtering for Cross-Store Demand Forecasting</strong> <a href="https://doi.org/10.1016/j.cie.2024.110067">[DOI]</a>. Ming Liang, Liping Yang, Kai Li, Hao Zhai. <em>Computers &amp; Industrial Engineering</em>, 190, 110067, 2024.</p>
  </article>
</div>

## OM Research with AI: My Thoughts

<div class="research-collection">
  <article class="research-entry">
    <p class="research-entry__citation"><strong>Overview of Artificial Intelligence in Platform-Based Supply Chains: Technological Challenges and Algorithmic Empowerment</strong>. Libo Sun, Liping Yang, Biyan Sun, Yugang Yu. Accepted at <em>Systems Engineering - Theory &amp; Practice</em>, 2026.</p>
  </article>
</div>
